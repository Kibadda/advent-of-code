--- @class AOCDay201602: AOCDay
--- @field input string[]
local M = require("advent-of-code.AOCDay"):new("2016", "02")
...
function M:solve1()
  return self:solver(V(0, 0), function(current)
    return {
      U = function()
...
function M:solve2()
  return self:solver(V(0, -2), function(current)
    return {
      U = function()
